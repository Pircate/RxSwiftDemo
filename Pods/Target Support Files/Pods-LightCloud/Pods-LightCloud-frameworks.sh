...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ExtensionX/ExtensionX.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FSCycleScrollView/FSCycleScrollView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RxExtension/RxExtension.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RxGesture/RxGesture.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RxNetwork/RxNetwork.framework"
